...
describe('index', function() {
  ...
  it('should replace import statements with uri', function() {
    const result = transformCode(getFixtures('import-image.js'), baseConfig)
      .code;
  ...
  it('should let you flatten the file path', function() {
    ...
    expect(result).to.equal(
      "const test = 'http://cdn.address/assets/icon.svg';"
    );
  });
  ...
  it('should replace import statements with uri and hash of content', function() {
    ...
    const result = transformCode(getFixtures('import-uri-hash.js'), config)
      .code;
    expect(result).to.equal(
  ...
  it('should replace require statements with uri', function() {
    const result = transformCode(getFixtures('require-image.js'), baseConfig)
      .code;
    expect(result).to.equal(
      "const test = 'http://cdn.address/assets/path/to/icon.svg';"
    );
